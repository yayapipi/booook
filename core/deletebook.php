...
if(isset($_SESSION['valid'])){
  ...
  $sql_update = "DELETE FROM booklist_".$_SESSION['login_user'].
   " WHERE id = " . ($_GET['id']);

 
  $conn->query($sql_update);
  echo '<br ><b><p class="text-success " >Delete Status :</p> ';
  echo '<button type="button" class="btn btn-inverse-danger btn-fw">The Book Had Been Deleted </button>';
  echo "<hr>";
