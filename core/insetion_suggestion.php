        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Suggestion Status</h4>
...
if(isset($_SESSION['valid'])){
  ...
  $sql_insert = "INSERT INTO Suggestion(name,email,suggestion) 
           VALUES('"
           .$_POST['name']. "','"
           .$_POST['email']. "','"
           .$_POST['suggestion']
  ...
  echo '<br ><b><p class="text-success " >Thanks For Your Suggestion</p> ';
  echo '<button type="button" class="btn btn-inverse-success btn-fw">Your Suggestion Is Submited Successfull</button>';
  echo "<hr>";
    echo '<br ><b><p class="text-danger " >The page will redirect to suggestion page after 2 second.</p> ';
